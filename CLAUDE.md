...
|---|---|---|
| `specs/00-…-14-….md` | Numbered system specs: vision, architecture, domain model, storage, ingestion, extractor contract, search, identity/permissions, API principles, previews, deployment, engineering standards, reliability, mobile clients, client sync & caching | Cross-reference by relative link; update in the same change as any behavior change |

...
- **FR-10** **The frame:** which instance, who is signed in, where you are, and a way out — present on every authenticated surface. Navigation reflects only what the API can actually do; no surface advertises a capability it does not yet offer.
